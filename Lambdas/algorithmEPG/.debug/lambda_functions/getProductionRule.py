...
def lambda_handler(event, context):
    ...
    try:
        ...
        if algoObj.get('Algorithm').get('algorithmName') != ruleObj.get('ProductionRule').get('Algorithm').get('algorithmName') or \
            algoObj.get('Algorithm').get('algorithmVersion') != ruleObj.get('ProductionRule').get('Algorithm').get('algorithmVersion'):
